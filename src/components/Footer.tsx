...
export const Footer = () => {
  return (
    <footer className="bg-nn-black border-t-4 border-nn-pink">
      {/* Newsletter Section */}
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="flex gap-4">
              <input
                ...
                className="flex-1 bg-background border-4 border-border px-4 py-3 text-foreground placeholder:text-muted-foreground focus:border-nn-pink focus:outline-none transition-colors font-body"
              />
              <motion.button
      ...
      <div className="container pb-12">
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-2">
            <img src={logo} alt="Nada Normal" className="h-20 w-auto mb-6" />
            ...
            <div className="flex gap-4">
              {socialLinks.map((social) => (
                <motion.a
                  ...
                  whileTap={{ scale: 0.9 }}
                  className="w-12 h-12 bg-card border-2 border-border hover:border-nn-pink hover:bg-nn-pink hover:text-nn-black flex items-center justify-center transition-all duration-300"
